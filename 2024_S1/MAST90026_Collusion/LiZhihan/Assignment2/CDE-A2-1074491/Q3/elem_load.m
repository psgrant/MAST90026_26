...
function F = elem_load(P1, P2, P3, f, quad_order)
    ...
    if (quad_order == 1) % oder1
        Load(1) = (f((P1(1) + P2(1) + P3(1)) / 3, (P1(2) + P2(2) + P3(2)) / 3) * K / 3) / 2;
        Load(2) = (f((P1(1) + P2(1) + P3(1)) / 3, (P1(2) + P2(2) + P3(2)) / 3) * K / 3) / 2;
        Load(3) = (f((P1(1) + P2(1) + P3(1)) / 3, (P1(2) + P2(2) + P3(2)) / 3) * K / 3) / 2;
        F = Load;
    else % oder 2
